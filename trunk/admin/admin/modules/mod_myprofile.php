...
if (isset($GLOBALS['pixie_user'])) {
		...
		print '<h2>' . $rname . ' ('; if (isset($uname)) { print $uname; } print ')   </h2>';
		...
		echo "\n\n\t\t\t\t<div id=\"myprofile_edit\">
 					<form accept-charset=\"UTF-8\" action=\"?s=$s&amp;x=$x&amp;do=security\" method=\"post\" id=\"form_myprofile\" class=\"form\">
 						...
 						<legend>Change your password</legend>		
		 					<div class=\"form_row "; if (isset($current_style)) { echo $current_style; } echo "\">
							...
							<div class=\"form_row "; if (isset($new_style)) { echo $new_style; } echo "\">
							...
							<div class=\"form_row "; if (isset($confirm_style)) { echo $confirm_style; } echo "\">
...
default:
		...
		if (isset($uname)) { $rs = safe_row('*', 'pixie_users', "user_name = '$uname' limit 0,1"); }
 					...
 					<form accept-charset=\"UTF-8\" action=\"?s=$s&amp;x=$x\" method=\"post\" id=\"form_myprofile\" class=\"form\">
 						...
 						<legend>Edit your profile</legend>		
							<div class=\"form_row "; if (isset($realname_style)) { echo $realname_style; } echo "\">
								...
								<div class=\"form_item\"><input type=\"text\" class=\"form_text\" name=\"realname\""; if (isset($realname)) { echo " value=\"$realname\""; } echo " size=\"40\" maxlength=\"80\" id=\"realname\" /></div>
							</div>
							<div class=\"form_row\">
							...
							<div class=\"form_row "; if (isset($website_style)) { echo $website_style; } echo "\">
	   				...
	   				echo "		<div class=\"form_row "; if (isset($link_1_style)) { echo $link_1_style; } echo "\">
								<div class=\"form_label\"><label for=\"link_1\">"; if (isset($lang['form_fl1'])) { echo $lang['form_fl1']; } echo " <span class=\"form_optional\">" . $lang['form_optional'] . "</span></label></div>
								<div class=\"form_item\"><input type=\"text\" class=\"form_text\" name=\"link_1\" value=\"$link_1\" size=\"40\" maxlength=\"80\" id=\"link_1\" /></div>
							</div>
							<div class=\"form_row "; if (isset($link_2_style)) { echo $link_2_style; } echo "\">
								<div class=\"form_label\"><label for=\"link_2\">"; if (isset($lang['form_fl2'])) { echo $lang['form_fl2']; } echo " </label></div>
								<div class=\"form_item\"><input type=\"text\" class=\"form_text\" name=\"link_2\" value=\"$link_2\" size=\"40\" maxlength=\"80\" id=\"link_2\" /></div>
							</div>
							<div class=\"form_row "; if (isset($link_3_style)) { echo $link_3_style; } echo "\">
								<div class=\"form_label\"><label for=\"link_3\">"; if (isset($lang['form_fl3'])) { echo $lang['form_fl3']; } echo " </label></div>
