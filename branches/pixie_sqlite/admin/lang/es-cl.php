...
// Title: Language File (Spanish CL).                              //
...
$lang = array(
    ...
    'tag_line' => 'El PequeÃ±o, Simple, Creador de Sitios',
    'latest_referrals' => 'Ãšltimas Referencias',
    'latest_activity' => 'Ãšltimas Actividades',
    ...
    'download' => 'Descargar',
    'delete' => 'Borrar',
    'delete_file' => 'Â¿Borrar archivo?',
    'theme_info' => 'Los temas que tiene instalado se listan a continuaciÃ³n. Puede instalar mas temas subiendo las carpetas de los mismos a admin/themes. Mas temas pueden ser descargados de <a href="http://www.getpixie.co.uk">www.getpixie.co.uk</a> o puede facilmente crear los suyos usando solo CSS. El tema actual se encuentra destacado.',
    ...
    'settings_page' => '',  //this is intencional left empty 'cos in spanish grammar u can't say "Limpiar Inicio pÃ¡gina" correct syntax will be "Limpiar pÃ¡gina inicio"
    'settings_plugin' => 'plugin',
    'plugins' => 'Plugins',
    'plugins_info' => 'Los plugins aÃ±aden nuevas funcionalidades al sitio',
    'empty' => 'Limpiar',
    'oops' => 'Ooops!',
    ...
    'tags' => 'Etiquetas',
    'upload' => 'Subido',
    'file_manager_info' => 'El tamaÃ±o maximo de los archivos esta configurado en 100Mb. Porfavor sea paciente cuando sube archivos grandes',
    ...
    'from_the' => 'desde el',
    'page_settings' => 'ConfiguraciÃ³n de la pÃ¡gina',
    'advanced' => 'Avanzado',
    'your_site_has' => 'Su sitio tiene',
    'visitors_online' => 'visita(s) online.',    
    'in_the_last' => 'en los Ãºltimos',
    'site_visitors' => 'Visitas en el sitio.',
    'page_views' => 'PÃ¡ginas vistas.',
    'spam_attacks' => 'Ataques Spam',
    'last_login_on' => 'Ãšltimo login:',
    'quick' => '',  //same as the adove in spanish it should be "Links rÃ¡pidos" no "RÃ¡pidos links"
    'links' => 'Links',
    'new_entry' => 'AÃ±adir entrada en: ',
    ...
    'help_settings_page_module' => 'Una pagina modulo aÃ±ade contenido espeficico al su sitio, Los modulos pueden ser descargados desde <a href="http://www.getpixie.co.uk">www.getpixie.co.uk</a>, un ejemplo es el modulo de eventos. Los modulos a veces estan incrustados con los plugins.',
    'help_settings_user_type' => 'Cuando aÃ±ade un usuario puede escoger entre tres tipos:',
    ...
    'help_settings_user_client' => '<b>Cliente</b> - Un cliente solo puede aÃ±adir contenido a Pixie, ellos no pueden cambiar ninguna configuraciÃ³n del sitio',
    ...
    // system messages
    'error_save_settings' => 'Error al guardar la configuraciÃ³n.',
    'ok_save_settings' => 'Su nueva configuraciÃ³n se guardo y se activo.',
    ...
    'unknown_edit_url' => 'La direcciÃ³n entregada para editar no es valida.',
    ...
    'profile_ok' => 'Su perfil se actualizÃ³.',
    ...
    'user_update_ok' => 'Guardada la nueva configuraciÃ³n',
    ...
    'file_upload_error' => 'Pixie tiene un problema al insertar la informaciÃ³n a la base de datos, el archivo debio ser subido de todos modos.',
    ...
    'form_build_fail' => 'No se pudo construir un formulario editable... Â¿ingreso los datos correctos en el modulo?',
    ...
    'bad_cookie' => 'Su cookie a desaparesido :( necesitarÃ¡ ingresar otra vez.',
    ...
    // helper
    'helper_plugin' => 'Usted no puede editar la configuraciÃ³n de los plugins, usando los botones que estan arriba puede vaciar el contenido o eliminar un plugin. Si elimina un plugin, por ejemplo el de comentarios, sus visitas no podran dejar comentarios en las pÃ¡ginas dinamicas ',
    'helper_nocontent' => 'Esta pagina no tiene ningÃºn contenido. use el boton verde de arriba para aÃ±adir la primera entrada (el boton verde no esta en el plugin de comentarios).',
    'helper_nopages' => 'Una ves un hombre sabio dijo, -un sitio web sin pÃ¡ginas es como un ave sin alas... no va a ningÃºn lugar-. Utilice el formulario de la derecha para aÃ±adir una nueva pÃ¡gina a su sitio. Una ves hecho esto este mensaje desapareserÃ¡.',
    'helper_nopages404' => 'Su sitio solo tiene una pÃ¡gina, esta es la pagina de error 404 la cual puede ser editada mÃ¡s abajo.',
    'helper_nopagesadmin' => 'Usted puede <a href="?s=settings">aÃ±adir mÃ¡s paginas en la seccion \'Setup Stuff\' </a> de Pixie.',
    'helper_nopagesuser' => 'Contacte al administrador del sitio para preguntar como puede aÃ±adir nuevas pÃ¡ginas.',
    'helper_search' => 'Su busqueda no devolvio ningÃºn resultado, Intente buscando nuevamente.',
    
    // navigation
    'nav1_settings' => 'ConfiguraciÃ³n',
    ...
    'nav2_theme' => 'Tema',
    'nav2_site' => 'Sitio',
    'nav2_settings' => 'ConfiguraciÃ³n',

    // forms
    'form_login' => 'Ingresar',
    'form_username' => 'Nombre de usuario',
    'form_password' => 'Password',
    'form_rememberme' => 'Â¿Desea que recuerde la sesiÃ³n en este computador?',
    'form_forgotten' => 'Â¿Olvidar su password?',
    ...
    'form_telephone' => 'TelÃ©fono',
    'form_email' => 'Email',
    'form_website' => 'Sitio web',
    'form_occupation' => 'Trabajo',
    'form_address_street' => 'DirecciÃ³n',
    'form_address_town' => 'Ciudad',
    'form_address_county' => 'RegiÃ³n',
    'form_address_pcode' => 'CÃ³digo Postal',
    'form_address_country' => 'Pais',
    'form_address_biography' => 'BiografÃ­a',
    ...
    'form_button_create_page' => 'Crear PÃ¡gina',
    ...
    'form_public' => 'PÃºblico',
    'form_optional'=> '(opcional)',
    'form_required'=> '*',
    'form_title'=> 'Titulo',
    'form_posted'=> 'Fecha &amp; Hora',
    'form_date' => 'Fecha &amp; Hora',
    'form_help_comments' => 'Â¿Desea que la gente comente en esta entrada?',
    'form_help_public' => 'Â¿Desea que esta entrada/pÃ¡gina sea visible en el sitio (si selecciona no esta se guardarÃ¡ como borrador).',
    'form_help_tags' => 'Las etiquetas funcionan como categorias y hacen que todo sea mas fÃ¡cil de encontrar. Ingrese palabras clave separadas por espacios.',
    'form_help_current_tags' => 'Sugerencias:',
    'form_help_current_blocks' => 'Bloques Disponibles:',
    'form_php_warning' => '(Esta pÃ¡gina contiene PHP. El editor a sido deshabilitado para permitir la ediciÃ³n cÃ³digo avanzado)',
    'form_legend_site_settings' => 'Ajuste la configuraciÃ³n del sitio',
    'form_site_name' => 'Nombre del sitio',
    'form_help_site_name' => 'Â¿Como le gustaria que se llamara su sitio?',
    'form_page_name' => 'Nombre de la URL',
    'form_help_page_name' => 'Esto se usarÃ¡ para crear un enlace (por ejemplo http://www.susitio.com/<b>elnombre</b>/)..',
    'form_page_display_name' => 'Nombre de la pÃ¡gina',
    'form_help_page_display_name' => 'Â¿Como le gustaria que se llamara su pÃ¡gina?',
    'form_page_description' => 'DescripciÃ³n de la pÃ¡gina',
    'form_help_page_description' => 'Escriba una descripciÃ³n para su pÃ¡gina.',
    'form_page_blocks' => 'Bloques de la pÃ¡gina',
    ...
    'form_help_searchable' => 'Â¿Desea que esta pÃ¡gina se encuentre en bÃºsquedas pÃºblicas?',
    'form_posts_per_page' => 'Entradas en esta pÃ¡gina',
    'form_help_posts_per_page' => 'Â¿Acuantas entradas desea que se muestren en esta pÃ¡gina?',
    'form_rss' => 'RSS',
    'form_help_rss' => 'Â¿Desea que esta pÃ¡gina genere un archivo RSS?',
    'form_in_navigation' => 'En el menu',
    'form_help_in_navigation' => 'Â¿Desea que esta pÃ¡gina se muestre en el menÃº de su sitio?',
    'form_site_url' => 'DirecciÃ³n del sitio',
    'form_help_site_url' => 'Cual es la direcciÃ³n de su sitio (ej: http://www.susitio.com/directorio/).',
    'form_site_homepage' => 'PÃ¡gina de inicio',
    'form_help_homepage' => 'Â¿Cual de sus pÃ¡ginas deasea que visiten primero sus visitas?',
    ...
    'form_help_site_curl' => 'Â¿Le gustaria que su sitio utilize URLs claras? Una URL clara se ve asÃ­ www.yoursite.com/clara/ cuando normalmente deberia verse www.yoursite.com/?s=clara. Esta funciÃ³n solo sirve para servidores sobre Linux',
    ...
    'form_help_pixie_dst' => 'Â¿Le gustaria que Pixie automaticamente ajustara la hora segÃºn el horario de ahorro de energia?',
    ...
    'form_help_pixie_rte' => 'Â¿Le gustaria usar el editor de texto TinyMCE? (este hace que editar sus pÃ¡ginas sea muy fÃ¡cil, pero no esta soportado por todos los navegadores)',
    'form_help_pixie_rte' => 'Would you like to use the TinyMCE text editor? (It makes editing of textareas really easy but is not fully supported across all browsers).',
    'form_pixie_logs' => 'Tiempo en el que expiren los registros (Logs)',
    'form_help_pixie_logs' => 'Â¿Despues de cuanto dÃ­as prefiere que expiren los registros? (Logs)',
    ...
    'form_help_settings_page_type' => 'Â¿QuÃ© tipo de pÃ¡gina le gustaria crear?',
    'form_legend_user_settings' => 'ConfigiraciÃ³n de usuario',
    ...
    'form_help_user_permissions' => 'Â¿Que permisos le gustaria que el usuario tenga?',
    'form_help_user_permissions_block' => 'Â¿Que tipo de usuario sera este?',
    ...
    'form_upload_replace_files' => 'Â¿Reemplazar el archivo?', 
    'form_help_upload_replace_files' => 'Â¿Esta intentando reemplazar el archivo?',
    'form_search_words' => 'Palabras clave',
    'form_privs' => 'Permisos de la pÃ¡gina',
    'form_help_privs' => 'Â¿A quien se le permitira modificar esta pÃ¡gina?', 
    ...
    'email_account_close_message' => 'Su cuenta de Pixie fue cerrada en '.$site_url.'. Contacte al administrador del sitio para mÃ¡s informaciÃ³n.',
    'email_account_close_subject' => 'Cuenta cerrada ('.str_replace("http://", "", $site_url).') ',
    'email_account_edit_subject' =>    'InformaciÃ³n importante sobre su cuenta ('.str_replace("http://", "", $site_url).') ',
    'email_account_new_subject' => 'Nueva cuenta ('.str_replace("http://", "", $site_url).') ',
    
    //front end
    'continue_reading' => 'Leer mÃ¡s',
    'permalink' => 'Permalink',
    'theme' => 'Tema',
    'navigation' => 'MenÃº',
    'skip_to_content' => 'Ir al contenido &raquo;',
    'skip_to_nav' => 'Ir al menÃº &raquo;',
    'by' => 'Por',
    'on' => 'el',
    'view' => 'Ver',
    'profile' => 'perfil',
